...
gsap.from(".home__santa", 1.2, { opacity: 0, y: -200, delay: 0.8 });
...
sr.reveal(".celeb__data", { origin: "left" });
sr.reveal(".celeb__img", { origin: "right" });
sr.reveal(".send__card:nth-child(1)");
sr.reveal(".send__card:nth-child(2)", { origin: "bottom", interval: 100 });
sr.reveal(".send__card:nth-child(3)");
sr.reveal(".send    .section__title");
sr.reveal(".footer__social li:nth-child(1)", { origin: "bottom" });
sr.reveal(".footer__social li:nth-child(2)", {
  duration: 3500,
  origin: "bottom",
});
sr.reveal(".footer__social li:nth-child(3)", {
  duration: 4500,
  origin: "bottom",
});
